...
<head>
    <title>Lunar Messaging (no reply)</title>
...
<body style="margin: 0;mso-line-height-rule: exactly;padding: 0;min-width: 100%;background-color: #ecf5f3">
<style type="text/css">
    body,
    .wrapper,
    .emb-editor-canvas {
    ...
    .wrapper blockquote {
        border-left: 4px solid #ecf5f3
    }
    .wrapper .three-col blockquote,
    .wrapper .narrower blockquote {
        border-left: 2px solid #ecf5f3
    }
...
<center class="wrapper" style="display: table;table-layout: fixed;width: 100%;min-width: 620px;-webkit-text-size-adjust: 100%;-ms-text-size-adjust: 100%;background-color: #ecf5f3">
                            ...
                            <table class="contents" style="border-collapse: collapse;border-spacing: 0;width: 100%">
                                ...
                                <tr>
                                    <td class="padded" style="padding: 0;vertical-align: top;padding-left: 50px;padding-right: 50px">
                                        <h1 style="Margin-top: 0;color: #3b3e42;font-weight: 400;font-size: 40px;Margin-bottom: 20px;font-family: sans-serif;line-height: 46px">@yield('header')</h1>
                                        <p style="Margin-top: 0;color: #60666d;font-size: 15px;font-family: sans-serif;line-height: 24px;Margin-bottom: 24px">@yield('body')</p>
    ...
    <table class="border" style="border-collapse: collapse;border-spacing: 0;font-size: 1px;line-height: 1px;background-color: #d4dddb;Margin-left: auto;Margin-right: auto" width="602">
        <tbody>
        <tr class="border" style="font-size: 1px;line-height: 1px;background-color: #e3e3e3;height: 1px">
            <td class="border" style="padding: 0;vertical-align: top;font-size: 1px;line-height: 1px;background-color: #d4dddb;width: 1px">&#8203;</td>
                            ...
                            <table class="contents" style="border-collapse: collapse;border-spacing: 0;width: 100%">
                                ...
                                <tr>
                                    <td class="padded" style="padding: 0;vertical-align: top;padding-left: 50px;padding-right: 50px">
                                        ...
                                        <h3 style="Margin-top: 0;color: #3b3e42;font-weight: 400;font-size: 18px;Margin-bottom: 12px;font-family: sans-serif;line-height: 26px">Sincerely,</h3>
                                        <span style="Margin-top: 0;color: #60666d;font-size: 15px;font-family: sans-serif;line-height: 24px;Margin-bottom: 10px;display: inline-block; width: 100%">
                                            <ul>
                                                Lunar Messaging
                                            </ul>
                                        </span>

                                        <h3 style="Margin-top: 0;color: #3b3e42;font-weight: 400;font-size: 13px;Margin-bottom: 40px;font-family: sans-serif;line-height: 26px;text-align:center;">This is an automated email, please do not reply.</h3>
    ...
    <table class="centered" style="border-collapse: collapse;border-spacing: 0;Margin-left: auto;Margin-right: auto">
        ...
        <tr>
            <td class="footer" style="padding: 0;vertical-align: top;letter-spacing: 0.01em;font-style: normal;line-height: 17px;font-weight: 400;font-size: 11px;Margin-right: auto;Margin-left: auto;padding-top: 50px;padding-bottom: 40px;width: 602px;color: #b9b9b9;font-family: sans-serif">
                <center>
                    <div class="address" style="Margin-bottom: 19px"></div>
